...
SELECT idCliente, nombre, cedula, direccion, telefono FROM clientes WHERE (idCliente = @idCliente)";
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[1].CommandText = "SELECT idCliente, nombre, cedula, direccion, telefono FROM dbo.clientes";
        ...
        public virtual int EliminarCliente(PrestamistaDataSet1.clientesDataTable dataTable)
        {
